...
const (
	...
	ParamTorqueLimit    uint16 = 69  // P-069: forward/positive torque limit (% of rated, default=300)
	ParamTorqueRevLimit uint16 = 70  // P-070: reverse/negative torque limit (% of rated, default=300)
